...
public class AG_FaturaPedidoTelecontrol implements ScheduledAction {
...
public void putFaturamento() throws Exception{
	    ...
	    try {
	        ...
	        while(rs.next()){
	        	...
	        	if(validarFaturamento(new BigDecimal(nunota))){
	        		...
	        		faturarPedido("http://api2.telecontrol.com.br/posvenda-faturamento/faturamentos", new BigDecimal(nunota));
...
public void faturarPedido(String ur, BigDecimal nunota) throws Exception {
...
public void updateTableFatur(BigDecimal nunota) throws Exception{
